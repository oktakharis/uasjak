          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">Jl. SELAMANYA</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+2 100 200 300</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">tekerayak@gmail.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> Hak Cipta (Tidak) Dilindungi | Dibuat oleh <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://instagram.com/oktakharis" target="_blank">Tekerayak</a>
